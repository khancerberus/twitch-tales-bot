export const Stories = {
    ...
    negative: '❌Rin intenta enviar un mensaje pidiendo ayuda, pero sólo recibe respuestas automáticas. Las luces de su habitación parpadean. En la comunidad virtual, nadie parece real ya. Rin se siente invisible.',
